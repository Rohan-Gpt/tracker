...
export default function MinimalisticCalendar() {
  ...
  const yearData: YearData = getCurrentYearData();
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="text-center py-8">
        <h1 className="text-2xl font-light tracking-wide">Time Visualized</h1>
      </div>

      <CalendarClient monthData={monthData} yearData={yearData} />
    </div>
  );
}
